            ...
            <div className="h-24 bg-zinc-900/90 backdrop-blur-2xl border-t border-white/5 px-10 flex items-center justify-between z-10 shrink-0">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="relative group/settings">
                        ...
                        {/* Settings Dropdown Wrapper (The Bridge) */}
                        <div className="absolute bottom-full right-0 pb-4 w-64 opacity-0 translate-y-2 pointer-events-none group-hover/settings:opacity-100 group-hover/settings:translate-y-0 group-hover/settings:pointer-events-auto transition-all duration-300 z-50">
                            {/* The Actual Visible Card */}
                            <div className="bg-zinc-900/95 backdrop-blur-xl border border-white/5 rounded-3xl p-3 shadow-2xl">
